        ...
        <div ref={rootRef} className={`relative ${className}`}>
            ...
            >
                {isLoading ? (
                    ...
                    <span className="min-w-0">
                        <span className="block truncate text-sm font-semibold text-slate-700 dark:text-slate-200">Роль недоступна в текущем списке</span>
            ...
            {isOpen && (
                <div role="listbox" className="absolute z-50 mt-1 max-h-72 w-full min-w-[16rem] overflow-y-auto rounded-xl border border-slate-200 bg-white p-1.5 shadow-xl dark:border-slate-700 dark:bg-slate-900 dark:shadow-black/40">
                    {!required && (
