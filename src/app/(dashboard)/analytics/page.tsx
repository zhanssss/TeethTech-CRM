    ...
    return (
        <div className="h-full flex flex-col space-y-6 overflow-y-auto pb-8 pr-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <StatCard title="Оплаченные заказы" value="20"  />
                <StatCard title="Не оплаченные Заказы" value="15"  />
                <StatCard title="Общее количество заказов" value="35" />
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
                ...
                <button
                    className='bg-blue-500 text-white w-48 py-3 rounded-xl cursor-pointer transition hover:bg-green-400'
                >
                    Выгрузить в Excell
                </button>
